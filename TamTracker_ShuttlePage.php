...
<head>
  ...
  <title>TamTracker Shuttle</title>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">SHUTTLE</li>
          </ol>
          <br>
    ...
    <div class="container-fluid py-4">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2"> 
              ...
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3"> 
                ...
                <h6 class="text-white text-capitalize ps-3">SHUTTLE TABLE</h6>
              </div>
            </div>
            ...
            <!--FOR WIDENING CARD CONTENTS-->
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="TT_SP_TABLE">
                  <thead>
                    <tr>
                      <h6>
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          ...
                          <td><?php echo $fetch['SHUTTLE_DRIVER']?></td>
                         ...
                         <td>
                              <a class="btn bg-gradient-info w-105" href="TamTracker_UPDATE_SP.php?id=<?php echo $fetch['SHUTTLE_NUMERO']?>">
                                  <span>
                              ...
                              <a class="btn bg-gradient-info w-105" href="TamTracker_ARCHIVE_SHUTTLE.php?id=<?php echo $fetch['SHUTTLE_NUMERO']?>">
                                  <span>
                                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                          <path fill="none" d="M0 0h24v24H0z"></path>
                                          <path fill="currentColor" d="M11 11V5h2v6h6v2h-6v6h-2v-6H5v-2z"></path>
      ...
      <center>
        ...
        <button class="btn bg-gradient-info w-105" onclick="location.href='TamTracker_CREATE_SP.php'">
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
            <path fill="none" d="M0 0h24v24H0z"></path>
            <path fill="currentColor" d="M11 11V5h2v6h6v2h-6v6h-2v-6H5v-2z"></path>
