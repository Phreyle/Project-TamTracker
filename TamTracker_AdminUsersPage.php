...
<head>
  ...
  <title>TamTracker Admin Users</title>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2"> 
              ...
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3"> 
                ...
                <h6 class="text-white text-capitalize ps-3">ADMIN USERS TABLE</h6>
              </div>
            </div>
            ...
            <!--FOR WIDENING CARD CONTENTS-->
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="TT_ADMINUSERS_TABLE">
                  <thead>
                    <tr>
                      <h6>
...
<!--BUTTON-->   
      ...
      <button class="btn bg-gradient-info w-105" onclick="location.href='TamTracker_CREATE_ADMINUSERS.php'">
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
            <path fill="none" d="M0 0h24v24H0z"></path>
            <path fill="currentColor" d="M11 11V5h2v6h6v2h-6v6h-2v-6H5v-2z"></path>
