  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0" id="TT_USERPAGE_TABLE">
                <thead>
                  <tr>
                    <h6>
                ...
                <tbody>
                  <?php
                      ...
                      $TT_USERPAGE_QUERY = mysqli_query($TT_DB, "SELECT * FROM `tt_user_table`") or die(mysqli_error());
                      while($fetch = mysqli_fetch_array($TT_USERPAGE_QUERY))
                      {
                  ?>
                        <tr>
                          <td><?php echo $fetch['UT_NUMERO']?></td>
                          <td><?php echo $fetch['UT_POSITION']?></td>
                          <td><?php echo $fetch['UT_OUTLOOK']?></td>
                          <td><?php echo $fetch['UT_CONTACT_NUMBER']?></td>
                          <td><?php echo $fetch['UT_FIRST_NAME']?></td>
                          <td><?php echo $fetch['UT_LAST_NAME']?></td>
                          <td><?php echo $fetch['UT_PASSWORD']?></td>
                          <td><?php echo $fetch['UT_ORAS']?></td>
                          <td><?php echo $fetch['UT_ORAS1']?></td>
                          <td><?php echo $fetch['UT_ORAS2']?></td>

                         <td>
                              <a class="btn bg-gradient-info w-105" href="TamTracker_UPDATE_USER.php?id=<?php echo $fetch['UT_NUMERO']?>">
                                  <span>
                              ...
                              <a class="btn bg-gradient-info w-105" href="TamTracker_ARCHIVE_USERS.php?id=<?php echo $fetch['UT_NUMERO']?>">
                                  <span>
                                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                          <path fill="none" d="M0 0h24v24H0z"></path>
                                          <path fill="currentColor" d="M11 11V5h2v6h6v2h-6v6h-2v-6H5v-2z"></path>
      ...
      <center>
        ...
        <button class="btn bg-gradient-info w-105" onclick="location.href='TamTracker_CREATE_USER.php'">
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
              <path fill="none" d="M0 0h24v24H0z"></path>
              <path fill="currentColor" d="M11 11V5h2v6h6v2h-6v6h-2v-6H5v-2z"></path>
